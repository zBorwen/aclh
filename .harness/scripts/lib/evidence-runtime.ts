...
export function evidenceExclusions(root:string,taskDir:string):string[] {
  return ['evidence.json','self-review-packet.md','self-review.json','review-packet.md','independent-review.json','review-decision.json','repair-authorization.json','review-history.json','managed-snapshot.json']
